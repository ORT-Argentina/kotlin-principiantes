 ...
 * Use the [WolverineFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class WolverineFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment WolverineFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WolverineFragment().apply {
